...
const PocketParkSearchScreen = () => {
  ...
  const handleSearchByName = async () => {
    const response = await fetch(`https://co2unter-hackyeah2024-backend.onrender.com/data/small-parks/by-name/${name}`);
    const data = await response.json();
    setResults(data);
  };

  const handleSearchByStatus = async () => {
    const response = await fetch(`https://co2unter-hackyeah2024-backend.onrender.com/data/small-parks/by-status/${status}`);
    const data = await response.json();
    setResults(data);
  };

  const handleSearchByDistrict = async () => {
    const response = await fetch(`https://co2unter-hackyeah2024-backend.onrender.com/data/small-parks/by-district/${district}`);
    const data = await response.json();
    setResults(data);
  };

  const handleSearchByAccessibility = async () => {
    const response = await fetch(`https://co2unter-hackyeah2024-backend.onrender.com/data/small-parks/by-accessibility/${accessibility}`);
    const data = await response.json();
    setResults(data);
  };

  const handleSearchByType = async () => {
    const response = await fetch(`https://co2unter-hackyeah2024-backend.onrender.com/data/small-parks/by-type/${type}`);
    const data = await response.json();
    setResults(data);
  };
